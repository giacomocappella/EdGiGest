...
<body>
        ...
        <table class="w-full">
            <tr>
                ...
                <td class="w-half">
                    ...
                    <div>Codice Fiscale {{$sys_admin->CF}}</div>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="footer margin-top">
        ...
        <div>Il sottoscritto dichiara che, nell’anno solare {{ $receipt->Anno }}, alla data odierna con questa prestazione non ha 
            conseguito redditi derivanti dall’esercizio di attività di lavoro autonomo occasionale eccedenti € 5.000,00.</div>
    </div>
    <div class="footer margin-top">
